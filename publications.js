...
const defaultPubs = [
  ...
  { id:4, cat:'direction', authors:'Paccosi T., Geylikman Z., Passarotti M., Bozia E. (eds.)', year:'en prép.', title:'Open Data for Quantitative Diachronic Linguistics', ref:'Journal of Open Humanities Data.', doi:'', badges:['prep'] },
  ...
  { id:8, cat:'chapitre', authors:'Geylikman Z.', year:'à paraître', title:'Le stéréotype nominal lié avec baron et son destin dans la chanson de geste en français médiéval', ref:'Dans <em>Naissance et vie des stéréotypes</em>. Rennes, PUR.', doi:'', badges:['prep'] },
  ...
  // ARTICLES
  { id:12, cat:'article', authors:'Geylikman Z.', year:'2025', title:'The Emergence of personne as a Negative Indefinite in Medieval and Pre-Classical French', ref:'<em>Journal of French Language Studies</em>.', doi:'' },
